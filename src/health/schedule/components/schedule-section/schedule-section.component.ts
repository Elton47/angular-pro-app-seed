import { Component, Input, Output, ChangeDetectionStrategy, EventEmitter } from "../../../../../node_modules/@angular/core";
  ...
  template: `
    <div class="schedule-section">
      ...
      <div>
        ...
        <ng-template #addMeal>
          <div class="schedule-section__item" (click)="onSelect('meals')">Assign meal</div>
        </ng-template>
        ...
        <ng-template #addWorkout>
          <div class="schedule-section__item" (click)="onSelect('workouts')">Assign workout</div>
        </ng-template>
      </div>
    </div>
  `
